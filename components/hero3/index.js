...
import hImg1 from "/public/images/samples/1.jpg";
import hImg2 from "/public/images/samples/2.jpg";
import hImg3 from "/public/images/samples/3.jpg";
import hImg4 from "/public/images/samples/4.jpg";
              ...
              <div className="col-xl-8 col-lg-6 col-md-5 col-12">
                <div className="static-hero-slide-img owl-carousel">
                  <Slider {...settings}>
                    ...
                    <div style={{ width: "400px", height: "1000px" }}>
                      <Image src={hImg3} alt="" objectFit="fill" priority />
                    </div>
                    <div style={{ width: "400px", height: "1000px" }}>
                      <Image src={hImg4} alt="" />
                    </div>
